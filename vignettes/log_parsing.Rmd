...
Parsing server log files is a common task in server administration REF.  Historically
R would not be well suited to this and it would be better performed using
a scripting language such as perl. Rex, however, makes this easy to do
